...
/* to store number of moves and matches found and check when first card is opened */
var moves = 0;
var match_found = 0;
...
/* randomze the cards generating the deck */
...
/* Disabling the click of the already open Cards */
function disableCLick() {
    openCards.forEach(function (card) {
        card.off('click');
    });
}
/* enabling the  click on the open card */
function enableClick() {
    openCards[0].click(toggleCard);
}
/* check openCards for matching */
